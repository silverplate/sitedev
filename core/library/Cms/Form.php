...
abstract class Core_Cms_Form
{
	...
	public function CreateGroup($_name, $_title) {
		$this->Groups[$_name] = new Core_Cms_FormGroup($_name, $_title);
	...
	public function CreateElement($_name, $_type, $_label = null, $_is_required = false) {
		$class_name = 'Core_Cms_Form_Element';
	...
	public function CreateButton($_label, $_name = null, $_image_url = null) {
		...
		$this->Buttons[$_name] = new Core_Cms_FormButton($name, $_label, $_image_url);
