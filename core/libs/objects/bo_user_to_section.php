...
class BoUserToSection extends ActiveRecord {
	...
	public static function GetBase() {
		if (!isset(self::$Base)) {
			...
			self::$Base->AddForeignKey(BoUser::GetBase(), true);
			self::$Base->AddForeignKey(BoSection::GetBase(), true);
		}
