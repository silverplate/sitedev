...
class File {
    ...
    /**
    * Usage example:
    * if (!File::checkUploadSize()) {
    *     $form->UpdateStatus = FORM_ERROR;
    *     $oversized = File::getOversizedFields();
    *
    ...
    */
    ...
    /**
    * For usage example see File::checkUploadSize().
    */
    ...
    *     File::getOversizedWarningMessage()
    * );
    */
